package com.bta.api.service.external;
...
public class CredentialsService {
    ...
    public UsersDto registerNewUser(RegisterUserDto dto) throws EntityExistsException {
        if (!dto.getEmail().contains("@")) {
            throw new StringIndexOutOfBoundsException("Email must have '@' before the domain");
        }
        if (dto.getFirstName().equals("admin") || dto.getLastName().equals("admin")) {
            throw new EntityExistsException("Cannot add 'admin' user");
        }
