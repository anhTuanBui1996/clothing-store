...
public class UserImplService implements ImplService<User, UserDto>, UserDetailsService {
    ...
    public User getById(UUID id) {
        return usersRepository.findById(id).orElseThrow(() -> new UserServiceCustomException("User with given Id not found", "USER_NOT_FOUND"));
    }
    ...
    public List<User> updateCollection(List<UserDto> dtos) {
        ...
        return (List<User>) usersRepository.saveAll(entities);
    }
